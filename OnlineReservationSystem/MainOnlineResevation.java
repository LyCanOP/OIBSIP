    ...
    public static void main(String[] args) {
        ...
        VisualForm.addLoginChangeListener(evt -> {
            if ("userLoggedIn".equals(evt.getPropertyName()) && (boolean) evt.getNewValue()) {
                ...
                if (new File("D://EDUCATION/INTERNSHIP/OASIS INFOBYTE/OnlineReservationSystem/UsersData/User" + form.currentUser + ".ser").exists()) {
                    System.out.println(form.currentUser);
                    if (form != null) {
                        try {
                            Objecct loadedForm = VisualForm.loadVisualFormFromFile("D://EDUCATION/INTERNSHIP/OASIS INFOBYTE/OnlineReservationSystem/UsersData/User" + form.currentUser + ".ser");
                            if (loadedForm != null) {
